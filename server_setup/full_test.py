...
def main():
    ...
    print("🧪 Полное тестирование работы приложения...\n")
    ...
    try:
        ...
        print("="*60)
        child.sendline('ss -tuln | grep -E ":8000|:5433"')
        child.expect([r'\$ ', r'# '], timeout=10)
        ...
        # Тест внешнего доступа с локальной машины
        ...
        try:
            ...
            print("❌ Внешний доступ: Connection refused (порт не открыт или приложение не запущено)")
